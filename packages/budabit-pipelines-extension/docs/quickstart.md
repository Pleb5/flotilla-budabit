...
> **Note:** This guide covers Smart Widgets, the supported extension model in Flotilla. For host-specific behavior, see the [Flotilla Extension Developer Guide](../../../docs/extensions/README.md).
