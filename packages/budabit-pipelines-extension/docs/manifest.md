...
Smart Widgets are the supported extension model in Flotilla. They are event-based, discovered as kind `30033` events, and can render inline or launch iframe widgets using the `button` tag.

For host-specific behavior, see the [Flotilla Extension Developer Guide](../../../docs/extensions/README.md).
