...
Read the [visibility contract](./visibility.md) when choosing a slot. Manifest
generation accepts `--visibility host|widget`; widget-controlled visibility is
supported only by the inline before/after quicklinks surfaces.
