...
const tasks = [
  {name: "app", color: "\x1b[32m", command: "pnpm", args: ["run", "dev:app"]},
  {
    name: "core",
    color: "\x1b[36m",
    command: "pnpm",
    args: ["--dir", "packages/nostr-git-core", "run", "watch"],
  },
  {
    name: "ui",
    color: "\x1b[35m",
    command: "pnpm",
    args: ["--dir", "packages/nostr-git-ui", "run", "watch"],
  },
]
...
console.log("\x1b[32m✓\x1b[0m dev:full started (app + core + ui). Press Ctrl+C to stop.\n")
