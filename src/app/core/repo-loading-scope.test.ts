...
describe("authoritative repository loading scope", () => {
  ...
  it("uses stable per-relay live lanes without root-set dependencies", () => {
    ...
    expect(layout).toContain("constliveActivityRelays=selectRepoLiveRelays(activityRelays)")
    expect(layout).toContain("constliveAnnouncementRelays=selectRepoLiveRelays(announcementRelays)")
